...
<?php
    ...
    function generateSIdeUser($dataExec){
        $infos =  $dataExec['getInfosUSER'];
...
<div class="col-span-12 lg:col-span-4 hidden lg:block h-screen sticky top-44">
                <div
                    ...
                    <!-- profile image -->
                    <img style="object-fit:cover" src="<?php echo($direURI); ?>view/assets/datas/images/profile_images/mini/<?php echo $infos['picture_link']; ?>"
                    ...
                    <div class="pt-[100px] pb-8">
                        ...
                        <div class="p-7 rounded-2xl mt-7 bg-[#F3F6F6] dark:bg-[#1D1D1D]">
                            <div class="flex border-b border-[#E3E3E3] dark:border-[#3D3A3A] pb-2.5">
                                ...
                                <div class="text-left ml-2.5">
                                    ...
                                    <p class="dark:text-white"><?php echo $infos['phone']; ?></p>
                                </div>
                            </div>
                            <div class="flex border-b border-[#E3E3E3] dark:border-[#3D3A3A] py-2.5">
                                ...
                                <div class="text-left ml-2.5">
                                    ...
                                    <p class="dark:text-white"><?php echo $infos['usermail']; ?></p>
                                </div>
                            </div>
                            <div class="flex border-b border-[#E3E3E3] dark:border-[#3D3A3A] py-2.5">
                                ...
                                <div class="text-left ml-2.5">
                                    ...
                                    <p class="dark:text-white"><?php echo $infos['cityof']; ?></p>
                                </div>
                            </div>
                            <div class="flex py-2.5">
                                ...
                                <div class="text-left ml-2.5">
                                    ...
                                    <p class="dark:text-white"><?php echo $infos['userange']; ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <button class="dowanload-btn">
                            <img class="mr-3" src="<?php echo($direURI); ?>view/assets/datas/images/icons/dowanload.png" alt="icon" /> Download CV </button>
                    </div>
                </div>
            </div>
            <?php
