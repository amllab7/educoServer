        ...
        <div class="row gx-4">
          ...
          <div class="col-auto my-auto">
            <div class="h-100">
              ...
              if($userData['statut']==1){

                $text= "En fonction";
                $state = 'checked';
              } else{   $text= "en Suspension";$state =''; }
              
              
              ?>
                    <input thestatut=<?php echo $userData['statut'];   ?> userid=<?php echo $userData['id'];   ?> class="form-check-input" type="checkbox" id="rememberMes" onchange="activeGuy(this);" <?php echo $state;   ?>>
                    <label class="form-check-label" for="rememberMe" id="retobVVV">Cette base est <?php echo $text;   ?></label>
              </div>
           ...
           <div class="card h-100">
             ...
             <div class="card card-profile card-plain">
                  <div class="card-body  text-center bg-white shadowXX border-radius-lg p-3">
                    ...
                    <button class="btn bg-gradient-success ">Totale Adhesion : 424 Membres</button>
                    <button class="btn bg-gradient-info addfile"  id="" keyval="AddCv">add</button>
                        ...
                        <ul class="list-group">
                          ...
                          <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                            ...
                            <div class="d-flex align-items-start flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">Competances</h6>
                          ...
                          <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                            ...
                            <div class="d-flex align-items-start flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">Réalisation</h6>
                              <p class="mb-0 text-xs">Voir liste</p>
                            </div>
                            <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto" href="javascript:;">
...
<?php 
                    ...
                    array("Nom axe",$userData['nom'],'username'),
                    array("Representant ",$userData['nom'],'prenom'),
                    array("Addresse ",$userData['nom'],'jobprofile'),
                    array("Description ",$userData['nom'],'phone'),
...
<button style="display:none" datatest="scsjoj" class="btn bg-gradient-info  "  id="themodifiermodal" data-bs-toggle="modal" data-bs-target="#themodifier">Modifier</button>
    ...
    <div class="container-fluid py-4">
       ...
       <button style=" float: right;margin-right : 20px ;margin-top : -10px " type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addDATA2">Ajouter une activite</button>
