          ...
          <div class="col-auto my-auto">
            <div class="h-100">
              ...
              if($userData['is_active']==1){
                ...
                $text= "activée";
                $state = 'checked';
              } else{   $text= "désactivée";$state =''; }
              
              
              ?>
                    <input thestatut=<?php echo $userData['is_active'];   ?> userid=<?php echo $userData['id'];   ?> class="form-check-input" type="checkbox" id="rememberMes" onchange="activeGuy(this);" <?php echo $state;   ?>>
            ...
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                ...
                <li class="nav-item" id="editorSDE" valueis="1">
                  <a class="nav-link mb-0 px-0 py-1 "  href="<?php echo($direURI); ?>admin/editprofil/<?php echo $userData['id'];   ?>" role="tab" aria-selected="false">
                ...
                <li class="nav-item inDeverXX">
                  <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="false">
                    ...
                    <span class="ms-1 clickModif" 
                      id=""  
                      dataval=""
                      datatitre= "Nouveau mot de pass"
                      thtable="user"
                      idcol="userpass"
                      idrow=<?php echo $userData['id']; ?> token="csjbhbsjc" >Parametres</span>
                  </a>
                </li>
              </ul>
            </div>
           ...
           <div class="card h-100">
             ...
             <div class="card card-profile card-plain">
                  <div class="card-body  text-center bg-white shadowXX border-radius-lg p-3">
                    ...
                    <button class="btn bg-gradient-info addfile"  id="" keyval="AddCv">CV de L'utulisat....</button>
                    <button class="btn bg-gradient-info addfile"  id="" keyval="postProfile" >Photo de profil </button>
                        ...
                        <ul class="list-group">
                          ...
                          <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                            ...
                            <div class="d-flex align-items-start flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">Competences</h6>
                              <p class="mb-0 text-xs">Voir liste</p>
                            </div>
                            <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto" href="javascript:;">
                                 <span type="button" class="btn btn-outline-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#addDATA2">Ajouter</span>
                            </a>
                          </li>
                          ...
                          <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                            ...
                            <div class="d-flex align-items-start flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">Réalisations</h6>
                              <p class="mb-0 text-xs">Voir liste</p>
                            </div>
                            <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto" href="javascript:;">
                                 <span type="button" class="btn btn-outline-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#addDATAxxxxx">Ajouter</span>
...
<?php 
                    ...
                    array("Nom",$userData['username'],'username'),
                    array("Prenom",$userData['prenom'],'prenom'),
                    array("Job profile",$userData['jobprofile'],'jobprofile'),
                    array("Numero de telephone: ",$userData['phone'],'phone'),
                    array("Lieu d'Habitation : ",$userData['cityof'],'cityof'),
                    array("Addresse mail",$userData['usermail'],'usermail'),
                    array("Age utilisateur",$userData['userange'],'userange'),
                    ...
                    <tr >
                     ...
                     <td class="align-middle text-center text-sm">
                      <button datatest="scsjoj" class="btn bg-gradient-info clickModif"  id="" 
                      dataval=<?php echo $value[1];?>
                      datatitre=<?php echo $value[0];?>
                      thtable="user"
                      idcol=<?php echo $value[2];?>
                      idrow=<?php echo $userData['id']; ?> token="csjbhbsjc">Modifier</button>
                      </td>
                 </tr> 
              <?php   } ?>
             </tbody>
    ...
    <div class="container-fluid py-4" style="display:none">
      <div class="row">
            <div class="col-12 col-xl-4">
              ...
              <div class="card-body p-3">
                        ...
                        <?php     
                          ...
                          <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                            ...
                            <div class="d-flex align-items-start flex-column justify-content-center">
                              ...
                              <p class="mb-0 text-xs"><?php echo $value['texte'];   ?></p>
                            </div>
                            <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto" href="javascript:;">
               ...
               <div class="text-center"><button type="button"  class="btn bg-gradient-primary col-md-10 addfileFF" data-bs-toggle="modal" data-bs-target="#addDATA2">Ajouter</button></div>  
      ...
      <div class="col-12 col-xl-4 " >
        ...
        <div class="col-12 col-xl-4 " >
          <div class="card h-100">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">REALISATIONS : <?php echo $userData['username'];   ?></h6>
            </div>
            <div class="card-body p-3">
            ...
            <div class="text-center"><button type="button" class="btn bg-gradient-primary col-md-10"  data-bs-toggle="modal" data-bs-target="#addDATAxxxxx">Ajouter</button></div> 
          </div>
        </div>
