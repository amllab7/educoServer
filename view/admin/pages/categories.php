...
$alluser = $dataExec['getAllcategories'];  
                    ...
                    <tr>
                       <td> 
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="<?php echo($direURI); ?>view/admin/assets/img/thefolder.png" class="avatar avatar-sm me-3 clickModif" alt="user1"
                          ...
                          thtable="videos"
                          idcol="hostid_vid"
                          idrow=<?php echo $value['id_cat']; ?> token="csjbhbsjc"
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            id=""   
                          repository="../"  
                          functionExec="updateCat" 
                          dataval="<?php echo $value['nom_cat'];   ?>"
                          datatypeok="Categories"
                          ...
                          style="cursor:pointer"
                            ...
                            >  <?php echo $value['nom_cat'];   ?>  </h6>

                            <p class="text-xs text-secondary mb-0 dblclickModif"
                            > <?php echo $value['nom_cat'];   ?> </p>
                      ...
                      <td> 
                        <p class="text-xs font-weight-bold mb-0"> <?php echo $value['nom_cat'];   ?></p>
                        <p class="text-xs text-secondary mb-0"> Admin <?php //echo $value['id_user'];   ?></p>
                        
                      </td>

                      <td class="align-middle text-center text-sm">
                            <?php if ($value['isvalid_cat']==1) { ?>
                                      <span idrow= <?php echo $value['id_cat'];?> functionExec="updateCat" datatypeok="Categories" idcol = 'isvalid_cat' repository = "../" dataval=0 class="badge badge-sm bg-gradient-success editActiv" style="cursor: pointer" >EN FONCTION</span>

                              <?php } else{   ?> <span idrow= <?php echo $value['id_cat'];?> functionExec="updateCat" datatypeok="Categories" idcol = 'isvalid_cat' repository = "../" dataval=1 class="badge badge-sm bg-gradient-danger editActiv" style="cursor: pointer">SUSPENDU :::</span> <?php   }   ?>
                      ...
                      <td class="align-middle text-center text-sm"> 
                         <a href="<?php echo($direURI); ?>admin/profile/<?php echo $value['id_cat'];?>"  data-toggle="tooltip" data-original-title="Edit user" >
              ...
              <div class="card-body">
                 <form id="adduserForm"> 
                  ...
                  <div class="input-group mb-3">
                    <input required='require' type="text"id="mail" name="titrevideo" class="form-control" placeholder="Email ou mot de pass" aria-label="Email" aria-describedby="email-addon">
                  </div>
