  ...
  <div class="container-fluid">
      <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('<?php echo($direURI); ?>view/admin/assets/img/curved-images/curved0.jpg'); background-position-y: 50%;">
      ...
      <div class="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
        <div class="row gx-4">
          ...
          <div class="col-auto">
            ...
            <label for="addIMAG">  <img src="<?php echo($direURI); ?>view/admin/assets/img/bruce-mars.jpg" alt="profile_image" class="w-100 border-radius-lg shadow-sm" id="realshows" style="max-height:100px">
            </label></div>
          </div>
  ...
  <div class="col-12 mt-4"   id="bodyContainer">
          ...
          <div class="card h-100">
            ...
            <form id='sendEdited' >
                            ...
                            <input type="hidden" class="form-control" value="edituser" id="edituser" name="funcExec">
                              ...
                              <div class="col-md-4">
                                <div class="form-group">
                                  <input type="text" class="form-control" value="<?php echo $userData['fbk'];   ?>" id="fbk" name="fbk"  placeholder = "Taper votre age">
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="form-group">
                                  <input type="text" class="form-control" value="<?php echo $userData['twitter'];   ?>" id="twitter" name="twitter"  placeholder = "Mot de pass">
                                </div>
                              </div>
