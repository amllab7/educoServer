...
$categories = $dataExec['categories'];
        ...
        <tr>
          <td>
            <div class="d-flex px-2 py-1">
              <div>
                <img src="<?php echo($direURI); ?>view/admin/assets/img/quality.png" class="avatar avatar-sm me-3">
              </div>
              <div class="d-flex flex-column justify-content-center">
                <h6 class="mb-0 text-xs"><?php echo $value['nom_cat']; ?></h6>
                <p class="text-xs text-secondary mb-0"> <?php echo $value['datecreted_cat']; ?> </p>
              </div>
            </div>
          </td>
          ...
          <?php if ($value['isvalid_cat']==1) { ?>
                                      ...
                                      <span idrow= <?php echo $value['id_cat'];?> functionExec="updatelivre" repository = "../../" datatypeok="livres" idcol = 'isactive_book' dataval=0 class="badge badge-sm bg-gradient-success editActiv" style="cursor: pointer" >EN FONCTION</span>

                              <?php } else{   ?> <span idrow= <?php echo $value['id_cat'];?> functionExec="updatelivre" repository = "../../" datatypeok="livres" idcol = 'isactive_book' dataval=1 class="badge badge-sm bg-gradient-danger editActiv" style="cursor: pointer">SUSPENDU :::</span> <?php   }   ?>
          ...
          <button 
          idrow= <?php echo $userData['id_user'];?> functionExec="updatevideo" datatypeok="videos" idcol = 'categorie_vid' 
          dataval="<?php echo $value['id_cat']; ?>" repository = "../../" reposit class="btn bg-gradient-info  editActiv" style="cursor: pointer" > Modifier </button>
