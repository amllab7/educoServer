...
<?php 
$getDATAcategorySET = $dataExec['getDATAcategorySET']; 
...
<section class="bg-white lg:rounded-2xl dark:bg-[#111111]">
                    <div class="container px-4 sm:px-5 md:px-10 lg:px-[60px]">
                        <div class="pb-12">
                        <h2 class="after-effect after:left-200 after:top-[76px] mb-12 md:mb-[30px] pl-4 md:pl-[60px] pt-12">
                        DONNEES </h2>
                            <div class="grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 mt-[30px] grid gap-x-10 gap-y-7 mb-6">
                                ...
                                <?php
                                 foreach ($getDATAcategorySET as $index => $value) {
                                    ...
                                    <div class="overflow-hidden rounded-lg">
                                        <a href="#ex1" rel="modal:open">
                                            <img class="rounded-lg w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110"
                                                src="<?php echo($direURI); ?>view/assets/datas/images/icons/folder.png" alt="blog image" />
                                        </a>
                                    </div>
                                    <div class="flex mt-4 text-tiny text-gray-lite dark:text-[#A6A6A6]">
                                        <span>Private</span>
                                        <span class="dot-icon">Locked</span>
                                    </div>
                                    <h3
                                        ...
                                        <a href="#ex1" rel="modal:open"><?php echo $value['dataname'];   ?> </a>
                                    </h3>
                                </div>
