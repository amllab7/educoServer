...
<?php 
$getMyWORKS = $dataExec['getMyWORKS']; 
...
<section class="bg-white lg:rounded-2xl dark:bg-[#111111]">
                    <div class="container px-4 sm:px-5 md:px-10 lg:px-[60px]">
                        <div class="pb-12"><br>
                            <h2 class=" "> <b><?php echo $userInfos['username'].'</b> de '.strtolower($userInfos['cityof']);   ?> - Réalisations</h2>
                            <div class="grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 mt-[30px] grid gap-x-10 gap-y-7 mb-6">
                                ...
                                <?php  foreach ($getMyWORKS as $index => $value) {
                              ...
                              ?>
                                ...
                                <div
                                    ...
                                    <div class="overflow-hidden rounded-lg">
                                        <a href="../workview/<?php echo $value['idrealistions']; ?>">
                                    ...
                                    <h3
                                        ...
                                        <a href="#ex1" rel="modal:open"><?php echo $value['titre'];   ?></a>
                                    </h3>
                                </div>
